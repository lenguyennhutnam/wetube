...
var ToggleGroup = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ToggleGroupPrimitive.Root, __assign({ ref: ref, className: utils_1.cn("flex items-center justify-center gap-1", className) }, props),
...
var ToggleGroupItem = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ToggleGroupPrimitive.Item, __assign({ ref: ref, className: utils_1.cn(toggle_1.toggleVariants({
