...
var DropdownMenuSubTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(DropdownMenuPrimitive.SubTrigger, __assign({ ref: ref, className: utils_1.cn("flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", inset && "pl-8", className) }, props),
        children,
