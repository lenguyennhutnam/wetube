...
var navigationMenuTriggerStyle = class_variance_authority_1.cva("group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-accent-foreground data-[state=open]:bg-accent/50 data-[state=open]:hover:bg-accent data-[state=open]:focus:bg-accent");
...
var NavigationMenuTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(NavigationMenuPrimitive.Trigger, __assign({ ref: ref, className: utils_1.cn(navigationMenuTriggerStyle(), "group", className) }, props),
        children,
        " ",
        React.createElement(lucide_react_1.ChevronDown, { className: "relative top-[1px] ml-1 h-3 w-3 transition duration-300 group-data-[state=open]:rotate-180", "aria-hidden": "true" })));
});
