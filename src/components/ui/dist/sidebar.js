...
var Sidebar = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: ref, className: "group peer hidden text-sidebar-foreground md:block", "data-state": state, "data-collapsible": state === "collapsed" ? collapsible : "", "data-variant": variant, "data-side": side },
        React.createElement("div", { className: utils_1.cn("relative w-[--sidebar-width] bg-transparent  ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset"
                ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
                : "group-data-[collapsible=icon]:w-[--sidebar-width-icon]") }),
        React.createElement("div", __assign({ className: utils_1.cn("fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] ease-linear md:flex", side === "left"
...
var SidebarTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(button_1.Button, __assign({ ref: ref, "data-sidebar": "trigger", variant: "ghost", size: "icon", className: utils_1.cn("h-7 w-7", className), onClick: function (event) {
        ...
        React.createElement(lucide_react_1.MenuIcon, null),
...
var SidebarGroupLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "group-label", className: utils_1.cn("flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", className) }, props)));
});
...
var SidebarGroupAction = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "group-action", className: utils_1.cn("absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring  hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", 
...
var sidebarMenuButtonVariants = class_variance_authority_1.cva("peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0", {
    variants: {
        variant: {
...
var SidebarMenuAction = React.forwardRef(function (_a, ref) {
    ...
    var Comp = asChild ? react_slot_1.Slot : "button";
    return (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "menu-action", className: utils_1.cn("absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring  hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0", 
        // Increases the hit area of the button on mobile.
...
var SidebarMenuSkeleton = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "menu-skeleton", className: utils_1.cn("flex h-8 items-center gap-2 rounded-md px-2", className) }, props),
